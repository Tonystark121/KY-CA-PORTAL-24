...
function CAfrontPage(props) {
  ...
  return (
    ...
    // <>
    //   <div className="container bg-colorOfbg xs:w-[700px] xs:h-[90rem] xs:flex-col ">
    //     <div className="text-center xs:w-[100%]">
    //       <h1 className="text-7xl font-bold m-7 mt-24 text-[white]">
    //         CAMPUS AMBASSADOR
    //       </h1>
    //       <h4 className="text-[white] xs:text-3xl">
    //         Be the face of Kashiyatra!
    //       </h4>
    //       <h5 className="text-[white] xs:text-3xl xs:m-7">
    //         Represent your college and lead the contingent among all others.
    //       </h5>
    //       <button className="bg-ca-page-btn-color border rounded-full p-3 h-auto w-40 font-bold text-4xl mt-7 box shadow-2xl xs:text-4xl">
    //         APPLY
    //       </button>
    //     </div>
    //     <div className="flex float-right mx-center justify-center items-center xs:w-[50%]">
    //       <div className="mt-[10%] mr-[27%] flex flex-col">
    //         <img
    //           className="absolute xs:w-[160px] xs:h-auto xs:ml-[-1%]"
    //           src={lamp}
    //           alt=""
    //         />
    //         <button
    //           className="p-1 h-[50px] w-[110px] text-white font-semibold absolute ml-[-0.6%] mt-[-0.5%] text-xl border rounded-full bg-colorOfLamp xs:w-[160px] xs:text-3xl xs:h-[65px]"
    //           onClick={handleTaphere}
    //         >
    //           Tap here
    //         </button>
    ...
    //         <img
    //           className={`h-[65%] w-[14%] ml-[-6%] mt-[42%] absolute z-1 xs:h-[55%] xs:w-[72%] xs:mt-[27%] xs:ml-[-15%] ${
    //             showCA ? "show" : "hidden"
    //           }`}
    //           src={lyt}
    //           alt=""
    ...
    //         <div className="flex ml-[4.25%] mt-[48%] absolute z-5 xs:mt-[10%] max-[369px]:ml-[-45%] min-[355px]:ml-[-66%]">
    //           <img className="xs:w-[90%]" src={leftPeople} alt="" />
    //           <img
    //             className={`xs:w-[80%] ${showCA ? "show" : "hidden"}`}
    //             src={caSvg}
    //             id="changingSvg"
    //             alt=""
    //           />
    //           <img
    //             className={`w-[20%] mt-5 xs:w-[80%] ${
    //               !showCA ? "show" : "hidden"
    //             }`}
    //             src={participant}
    //             alt=""
    //           />
    //           <img className="w-[25%] xs:w-[90%]" src={rightPeople} alt="" />
    //         </div>
    //         <div className="mt-[70%] ml-3 absolute z-3 min-[300px]:w-[120%] xs:mt-[110%] xs:ml-[-80px]">
    //           <img
    ...
    //           />
    //         </div>
    //         <span className="mt-[80%] mr-24 text-[white] font-bold text-center absolute xs:mt-[350%] xs:ml-14 xs:text-4xl">
    //           {showCA ? "CA" : "PARTICIPANTS"}
    //         </span>
    //       </div>
    //     </div>
